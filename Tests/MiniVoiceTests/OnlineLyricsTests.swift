...
final class OnlineLyricsTests: XCTestCase {
    ...
    func testPreviewPrefersMatchingTimedRecording() throws {
        ...
        XCTAssertEqual(results.sorted { $0.score(title: "Same Song", artist: "Right Artist", duration: 200) > $1.score(title: "Same Song", artist: "Right Artist", duration: 200) }.first?.id, 2)
